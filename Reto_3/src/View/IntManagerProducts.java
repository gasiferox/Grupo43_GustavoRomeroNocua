 ...
 * @author maverick
 */
public class IntManagerProducts extends javax.swing.JDialog {

    /**
     * Creates new form IntProducts
     */
    public IntManagerProducts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btn_goHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_goHomeActionPerformed
        // TODO add your handling code here:
        IntManagerProducts.this.setVisible(false); // Close the JDialog
...
//            txt_productAvailability.setText(clientEmail);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntManagerProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IntManagerProducts dialog = new IntManagerProducts(new javax.swing.JFrame(), true);
