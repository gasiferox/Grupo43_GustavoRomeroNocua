...
//                jlInfoClient.setText("<html> Nombre:             " + client.getName() + "<br/>Documento:          " + client.getId() + "Dirección:          " + client.getAddress() + "<br/>Teléfono:           " + client.getPhone() + "<br/>Correo electrónico: " + client.getEmail() + "<br/>Cuenta bancaria:    " + client.getAccount().getAccountNumber() + "<br/>Saldo disponible:   $" + client.getAccount().getBalance() + "</html>");
    ...
    void clientsListByCode() {
        ...
        Client client_04 = new Client("Pepito Perez", "1000001", "Cra 1 con calle 1", "300111111", "pepito@gmail.com", account_01);
        Account account_05 = new Account(100000, "10001000-1");
        Client client_05 = new Client("Pepito Perez", "1000001", "Cra 1 con calle 1", "300111111", "pepito@gmail.com", account_01);
    }
