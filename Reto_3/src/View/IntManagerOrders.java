 ...
 * @author maverick
 */
public class IntManagerOrders extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntManagerOrders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IntManagerOrders dialog = new IntManagerOrders(new javax.swing.JFrame(), true);
